...
public void getBrowser(String browser){
	if(System.getProperty("os.name").contains("Fedora"))
		System.out.println(System.getProperty("os.name"));
	{
		if(browser.equalsIgnoreCase("firefox")){
			...
			//https://chromedriver.storage.googleapis.com/index.htmlSystem.setProperty("webdriver.chrome.driver", System.getProperty("user.dir")+"\\drivers\\chromedriver.exe");
...
public void loadPropertiesFile() throws IOException{
	...
	f1 = new File(System.getProperty("user.dir")+"/src/main/java/com/hybridFramework/properties/home.properties");
	file = new FileInputStream(f1);
	OR.load(file);
...
//	    test.driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
//	    test.driver.get(test.OR.getProperty("url"));
//	    System.out.println(test.OR.getProperty("url"));
//	    test.driver.findElement(ByXPath)
